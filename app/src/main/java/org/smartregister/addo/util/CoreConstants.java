...
import static org.smartregister.addo.util.CoreConstants.EventType.MALARIA_FOLLOW_UP_VISIT;
import static org.smartregister.addo.util.CoreJsonFormUtils.ENCOUNTER_TYPE;
...
public class CoreConstants {
    ...
    public static class JSON_FORM {
        ...
        public static final String DANGER_SIGNS_MEDICATION_CHILD = "danger_signs_medication_child";
        public static final String DANGER_SIGNS_MEDICATION_ANC = "danger_signs_medication_anc";
        ...
        public static String getDangerSignMedicationChild() { return DANGER_SIGNS_MEDICATION_CHILD; };

        public static String getDangerSignsMedicationAnc() { return DANGER_SIGNS_MEDICATION_ANC; }

        public static String getAddoCommodities() { return ADDO_COMMODITIES; }
